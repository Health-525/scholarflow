  ...
  if (!data) {
    return (
      <div className="pb-24 md:pb-8 max-w-md mx-auto py-16 px-4 text-center">
        ...
        <button onClick={() => window.location.reload()} className="px-4 py-2 rounded-xl text-[13px] font-medium"
          style={{ background: "var(--accent)", color: "#fff" }}>刷新</button>
      </div>
    );
  }
    ...
    <div className="pb-24 md:pb-8 max-w-5xl mx-auto py-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {openLibs.map((lib: LibraryRoom) => {
          ...
          return (
            <div key={lib.lib_id} className="rounded-xl p-4" style={{ background: "var(--surface-card)", border: "1px solid var(--border)", boxShadow: "var(--shadow-xs)" }}>
