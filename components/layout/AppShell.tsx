  ...
  return (
    <div className="relative flex min-h-screen bg-background">
      ...
      <div className="relative z-[1] flex-1 flex flex-col h-screen min-w-0">
        ...
        {!online && (
          <div className="px-4 py-2.5 flex items-center justify-center gap-2 text-[12px] font-medium bg-amber-500/8 text-amber-600 border-b border-amber-500/15 animate-fade-in sticky top-[36px] z-10">
