...
const SHORTCUTS: ShortcutItem[] = [
  ...
  { key: "Ctrl+4", description: "笔记", action: "/notes" },
  { key: "Ctrl+5", description: "日报", action: "/reports/daily" },
  { key: "Ctrl+6", description: "屏幕时间", action: "/activity" },
  { key: "Ctrl+7", description: "AI 助手", action: "/chat" },
